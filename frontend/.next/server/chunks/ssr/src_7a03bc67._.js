                        ...
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("ul", {
                                ...
                                children: [
                                    ...
                                    (!device.history || device.history.length === 0) && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("li", {
...
function DeviceForm({ initial, onSubmit, onCancel }) {
    ...
    const [noteLoading, setNoteLoading] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(false);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        if (!initial) return;
        fetch(`${process.env.NEXT_PUBLIC_API_URL || 'http://localhost:8000'}/api/devicenotes/?device=${initial.id}`).then((res)=>res.json()).then((data)=>setNotes(data));
        fetch(`${process.env.NEXT_PUBLIC_API_URL || 'http://localhost:8000'}/api/devicedocuments/?device=${initial.id}`).then((res)=>res.json()).then((data)=>setDocuments(data));
    }, [
        initial
    ]);
    ...
    async function handleDeleteDoc(id) {
        ...
        try {
            const response = await fetch(`${process.env.NEXT_PUBLIC_API_URL || 'http://localhost:8000'}/api/devicedocuments/${id}/`, {
                method: 'DELETE'
            });
            if (!response.ok) {
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("select", {
                                ...
                                children: [
                                    ...
                                    locationOptions.map((opt)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("option", {
                                            value: opt,
                                            children: opt
                                        }, opt, false, {
                                            fileName: "[project]/src/components/DeviceForm.tsx",
...
function DevicesPage() {
    ...
    const loadDevices = async ()=>{
        setLoading(true);
        try {
            const data = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$libs$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["fetchDevices"])();
            setDevices(data);
            setError(null);
        } catch (e) {
            setError(e.message);
    ...
    const handleAdd = async (data)=>{
        try {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$libs$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["createDevice"])(data);
            await loadDevices();
            setOpen(false);
        } catch (e) {
            alert(e.message);
    ...
    const handleEdit = async (id, data)=>{
        try {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$libs$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["updateDevice"])(id, data);
            await loadDevices();
        } catch (e) {
            alert(e.message);
        }
    ...
    const handleDelete = async (id)=>{
        try {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$libs$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["deleteDevice"])(id);
            await loadDevices();
        } catch (e) {
            alert(e.message);
        }
...
//# sourceMappingURL=src_7a03bc67._.js.map